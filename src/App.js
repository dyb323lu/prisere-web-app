      ...
      <aside className="w-64 bg-white p-6 shadow-md">
        ...
        <nav>
          <ul className="space-y-2">
            <li><a href="#" className="flex items-center p-2 bg-gray-200 rounded"><Home className="mr-2" /> Home</a></li>
      ...
      <main className="flex-1 p-8">
        ...
        <nav className="mb-8">
          <ul className="flex space-x-6 border-b">
            <li><a href="#" className="pb-2 border-b-2 border-transparent">Overview</a></li>
